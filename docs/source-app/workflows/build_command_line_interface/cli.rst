...
To create your first CLI, you need to override the :class:`~lightning.core.flow.LightningFlow.configure_commands` hook and return a list of dictionaries where the keys are the commands and the values are the server side handlers.
