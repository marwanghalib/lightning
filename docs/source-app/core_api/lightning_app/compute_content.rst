...
a :class:`~lightning.utilities.packaging.cloud_compute.CloudCompute` to your work ``__init__`` method:
...
.. autoclass:: lightning.utilities.packaging.cloud_compute.CloudCompute
    :noindex:
