...
Write a file
************
To write a file, first create a reference to the file with the :class:`~lightning.storage.Path` class, then write to it:
...
.. code-block:: bash
    ...
    lightning run app docs/source-lit/workflows/share_files_between_components/app.py
