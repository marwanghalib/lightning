...
Once the file is uploaded, we are putting the file into the :class:`~lightning.storage.drive.Drive`, so it becomes persistent and accessible to all Components.
